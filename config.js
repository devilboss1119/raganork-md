...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/hTaHkK8.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '𝚫𝐋𝚯𝚴𝚵.𝚩𝚯𝐘;https://i.imgur.com/MFtxOEU.jpg;https://chat.whatsapp.com/CTK8KS0JaosEuVNuWt0XK4',
    RBG_KEY: process.env.RBG_KEY || 'https://www.remove.bg/',
    ALLOWED: process.env.ALLOWED || '91',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"𝐂𝚮𝚰𝚴𝚴𝐔𝚭",
    BOT_NAME: process.env.BOT_NAME || '𝐂𝚮𝚰𝚴𝚴𝐔𝚭k',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '𝐂𝚮𝚰𝚴𝚴𝐔𝚭;𝚫𝐋𝚯𝚴𝚵.𝚩𝚯𝐘;https://i.imgur.com/MFtxOEU.jpg' : process.env.AUDIO_DATA,
